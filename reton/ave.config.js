...
const config = {
  ...
  About: {
    ...
    <p> I was born in 1991 and grew up in Puebla, Mexico.
        After I finished studying as an automotive design engineer, I started working on projects for <span>Volkswagen</span>.
        Then, I joined <span>Lightyear's</span> mission, where I helped develop the world's first long-range solar electric vehicle that's production-ready. </p>
